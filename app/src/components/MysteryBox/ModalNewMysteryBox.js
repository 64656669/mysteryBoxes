...
import MysteryBoxDeployed from './MysteryBoxDeployed.js'
import Modal from '../Modal/Modal.js';

import './ModalNewMysteryBox.scss';


const ethers = require("ethers") ;

function  ModalNewMysteryBox(){    
    ...
    return(
        <Modal 
            content={ isMysteryBoxDeployed && isMysteryKeyDeployed ? 
                <MysteryBoxDeployed addressBox= {AddressContractBox} addressKey= {AddressContractKey} addressTo={AddressReceiver}/>
                :
                getContent() 
            }
            isOpen={ true }
...
export default ModalNewMysteryBox;
