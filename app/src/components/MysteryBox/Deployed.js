                        ...
                        <div className="modal-body">
                            <form id="inputs">
                                <div className="form-group mx-2 mb-3">
                                    ...
                                    <input type="text" className="form-control address" name="token_address" onChange={onChangeAddress}/>
                                </div>
                                <div className="form-group mx-2">
                                    <label for="lastname">Enter the amount to transfer (or ID if NFT)</label>
                                    <input type="text" className="form-control amount" name="quantity" onChange={onChangeQuantity}/>
                                </div>
                            </form>
                        </div>  
